...
def navegar( url,indice):
    # Enviar el formulario
    driver.get(url)
    buscador = driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/section/div/section[2]/div/div/input")
    ...
    # Tomar y guardar una captura de pantalla
    driver.save_screenshot(f'prueba_buscarrepuestos_{indice}.png')

# Realizar las pruebas
url2 = "http://localhost:8000/adminlte/agregar_repuesto/"
login(credencial)
for i in range(0, 4):
    navegar(url2, i)
