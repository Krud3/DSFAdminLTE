...
def cerrarSesion(indice):
    # Enviar el formulario
    #driver.get(url)
    driver.save_screenshot(f'antesDeCerrar_{indice}.png')
    submit_button = driver.find_element(By.XPATH, "/html/body/div[1]/aside/div/div[4]/div/div/nav/ul/form/button")
    submit_button.click()
    driver.save_screenshot(f'despuesDeCerrar_{indice}.png')
    # Pausa para que la página se actualice
    time.sleep(2)
